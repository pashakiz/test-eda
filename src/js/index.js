...
function autocomplete(inp, arr) {
    ...
    inp.addEventListener('input', function(e) {
        ...
        for (i = 0; i < arr.length; i++) {
            ...
            if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
                ...
                el_htmlAutocompleteListItemTxt.innerHTML = '<strong>' + arr[i].substr(0, val.length) + '</strong>';
                el_htmlAutocompleteListItemTxt.innerHTML += arr[i].substr(val.length);
    ...
    inp.addEventListener('keydown', function(e) {
        ...
        if (x) x = x.getElementsByClassName('autocomplete-list__item');
        if (e.keyCode == 40) {
